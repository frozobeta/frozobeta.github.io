...
<html>
 ...
 <!-- <script>
  ...
  <h1 class="page-title">
    <span class="page-title-span"><i>Κατηγορία:</i></span>
    Διαδίκτυο
  </h1>
...
<div class="courses-wrap">
  <a href="#" class="course-link">  <div class="course">
      ...
      <p class="course-category"><span class="category-text">Κατηγορία: </span><span class="category-tag" onclick="document.location.href = 'http://frozoweb.com'; return false">Διαδίκτυο</span></p>
