...
<html>
  <head>
    ...
    <title>Login - InfinityGreece Academy</title>
...
<span class="line bot"></span>
  ...
  <p class="form-problem-text">Ο κωδικός δεν είναι σωστός.</p>
  <p class="already-have-account">Δεν έχεις λογαριασμό; <a href="login.php">Κάνε εγγραφή εδώ!</a></p>
  <footer>
